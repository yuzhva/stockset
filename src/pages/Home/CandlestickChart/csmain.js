...
import { genType, timeCompare, dataCompress } from './csdataprep';
import csheader from './csheader';

import stockdata from './stockdata.csv';

export var TPeriod      = "3M";
var TDays        = {"1M":21, "3M":63, "6M":126, "1Y":252, "2Y":504, "4Y":1008 };
export var TIntervals   = {"1M":"day", "3M":"day", "6M":"day", "1Y":"week", "2Y":"week", "4Y":"month" };
...
function displayCS() {
    var chart       = cschart(genData).Bheight(460);
